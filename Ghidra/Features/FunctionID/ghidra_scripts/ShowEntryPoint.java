...
public class ShowEntryPoint extends GhidraScript {
    ...
    protected void run() throws Exception {
        ...
        DomainFolder folder = askProjectFolder("Please select a project folder to display entrypoint:");
            ...
            try {
                ...
                for (Function function : functions) {
                    ...
                    if (function.getName().equals("_start")) {
                        println("EntryPoint address is :" + function.getEntryPoint());
                        break;
                    }
                }
            } catch (Exception e) {
